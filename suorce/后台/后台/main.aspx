<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="后台.WebForm2" %>
			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right theme-container" >
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-tint"></i><span class="hidden-phone"> 更换皮肤 </span>
						<span class="caret"></span>
					</a>
					<ul class="dropdown-menu" id="themes">
						<li><a data-value="classic" href="#"><i class="icon-blank"></i> 经典款 </a></li>
						<li><a data-value="cerulean" href="#"><i class="icon-blank"></i> 天空蓝 </a></li>
						<li><a data-value="cyborg" href="#"><i class="icon-blank"></i> 深夜蓝</a></li>
						<li><a data-value="redy" href="#"><i class="icon-blank"></i> 宝石红</a></li>
						<li><a data-value="journal" href="#"><i class="icon-blank"></i> 日记白</a></li>
						<li><a data-value="simplex" href="#"><i class="icon-blank"></i> 极简主义</a></li>
						<li><a data-value="slate" href="#"><i class="icon-blank"></i> 石板灰</a></li>
						<li><a data-value="spacelab" href="#"><i class="icon-blank"></i> 空间站</a></li>
						<li><a data-value="united" href="#"><i class="icon-blank"></i> 正品红</a></li>
					</ul>
				</div>
				<!-- theme selector ends -->
				...
				<div class="btn-group pull-right" >
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i><span class="hidden-phone"> <%=SUserName %></span>
						<span class="caret"></span>
					</a>
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<p id="hoverdata">鼠标位置 (<span id="x">0</span>, <span id="y">0</span>). <span id="clickdata"></span></p>
					</div>
				</div>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i> 环状图</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
